(function () {
  ...
  const phraseCopy = {
    fr: {
      ...
      "al mes": "par mois",
      "Verificando tu pago Premium...": "Vérification de ton paiement Premium...",
      "El pago Premium todavía se está verificando.": "Le paiement Premium est encore en cours de vérification.",
      "No se ha podido verificar el pago Premium.": "Impossible de vérifier le paiement Premium.",
      "Pago Premium cancelado.": "Paiement Premium annulé.",
      ...
      "No se ha podido abrir el pago Premium.": "Impossible d’ouvrir le paiement Premium.",
      "¿Quieres detener Premium? No habrá más cobros y conservarás tus ventajas hasta el final del periodo pagado.": "Tu veux arrêter Premium ? Il n’y aura plus de prélèvement et tu garderas tes avantages jusqu’à la fin de la période payée.",
      "Premium detenido. No habrá más cobros y conservarás tus ventajas hasta el final del periodo pagado.": "Premium arrêté. Il n’y aura plus de prélèvement et tu garderas tes avantages jusqu’à la fin de la période payée.",
      "No se ha podido detener Premium.": "Impossible d’arrêter Premium.",
      "Estado": "Statut",
      "Pago al día": "Paiement à jour",
      "Pago fallido": "Paiement échoué",
      "Se termina pronto": "Se termine bientôt",
      "Sin activar": "Non activé",
      "Próximo cobro": "Prochain prélèvement",
      "Activo hasta": "Actif jusqu’au",
      ...
      "Fotos guardadas": "Photos enregistrées",
      "Tus fotos de Quedar se han actualizado correctamente. Tus planes publicados usarán estas fotos.": "Tes photos de Plans ont été mises à jour correctement. Tes plans publiés utiliseront ces photos.",
      "Mínimo 2 fotos": "Minimum 2 photos",
      "No puedes eliminar todas tus fotos porque tienes planes publicados. Deja mínimo 2 fotos para que tus planes sigan visibles y seguros.": "Tu ne peux pas supprimer toutes tes photos parce que tu as des plans publiés. Garde au minimum 2 photos pour que tes plans restent visibles et sûrs.",
      ...
      "Se cobra con tarjeta ahora y después automáticamente cada mes desde Stripe. Si el pago falla, Premium se pausa y desaparece la certificación hasta que lo actives otra vez.": "Le paiement se fait par carte maintenant puis automatiquement chaque mois via Stripe. Si le paiement échoue, Premium se met en pause et la certification disparaît jusqu’à réactivation.",
      "Se cobra con tarjeta ahora y después automáticamente cada mes desde Stripe. Puedes detener Premium cuando quieras: no habrá más cobros y conservarás tus ventajas hasta el final del periodo pagado.": "Le paiement se fait par carte maintenant puis automatiquement chaque mois via Stripe. Tu peux arrêter Premium quand tu veux : il n’y aura plus de prélèvement et tu garderas tes avantages jusqu’à la fin de la période payée.",
      "Premium está detenido. No habrá más cobros y conservarás la certificación hasta el final del periodo pagado.": "Premium est arrêté. Il n’y aura plus de prélèvement et tu garderas la certification jusqu’à la fin de la période payée.",
      "Premium detenido": "Premium arrêté",
      "Tu certificación sigue activa hasta": "Ta certification reste active jusqu’au",
      "Después se quitará automáticamente.": "Ensuite elle sera retirée automatiquement.",
      "El último cobro no se pudo hacer. Vuelve a activar Premium con tarjeta para recuperar la certificación.": "Le dernier prélèvement n’a pas pu être effectué. Réactive Premium par carte pour récupérer la certification.",
      ...
      "Detener Premium": "Arrêter Premium",
      "Entendido": "Compris",
      "Planes": "Plans",
